    ...
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            ViewBag.Movies = from s in _context.Actors
                             join e in _context.ActorMovies on s.ActorId equals e.ActorId
        ...
        public async Task<IActionResult> Create([Bind("ActorId,Name,Email,Age")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ActorId,Name,Email,Age")] Actor actor)
        {
            if (id != actor.ActorId)
            {
                return NotFound();
